...
namespace EventReminder.Domain.Core.Primitives.Result
{
    ...
    public static class ResultExtensions
    {
        ...
        public static Result<T> Ensure<T>(this Result<T> result, Func<T, bool> predicate, Error error)
        {
            ...
            return result.IsSuccess && predicate(result.Value) ? result : StreamingService.Domain.Core.Primitives.Result.Result.Failure<T>(error);
        }
        ...
        public static Result<TOut> Map<TIn, TOut>(this Result<TIn> result, Func<TIn, TOut> func) =>
            result.IsSuccess ? func(result.Value) : StreamingService.Domain.Core.Primitives.Result.Result.Failure<TOut>(result.Error);
        ...
        /// </returns>
        public static async Task<StreamingService.Domain.Core.Primitives.Result.Result> Bind<TIn>(this Result<TIn> result, Func<TIn, Task<StreamingService.Domain.Core.Primitives.Result.Result>> func) =>
            result.IsSuccess ? await func(result.Value) : StreamingService.Domain.Core.Primitives.Result.Result.Failure(result.Error);
        ...
        public static async Task<Result<TOut>> Bind<TIn, TOut>(this Result<TIn> result, Func<TIn, Task<Result<TOut>>> func) =>
            result.IsSuccess ? await func(result.Value) : StreamingService.Domain.Core.Primitives.Result.Result.Failure<TOut>(result.Error);
        ...
        /// </returns>
        public static async Task<T> Match<T>(this Task<StreamingService.Domain.Core.Primitives.Result.Result> resultTask, Func<T> onSuccess, Func<Error, T> onFailure)
        {
            StreamingService.Domain.Core.Primitives.Result.Result result = await resultTask;
